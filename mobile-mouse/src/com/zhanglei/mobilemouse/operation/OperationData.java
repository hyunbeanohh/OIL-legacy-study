...
public class OperationData {
    ...
    public static final int OPERATION_SCROLL_UP_DOWN = 6;
    public static final int OPERATION_SCROLL_UP_UP = 7;
    public static final int OPERATION_SCROLL_DOWN_DOWN = 8;
    public static final int OPERATION_SCROLL_DOWN_UP = 9;
